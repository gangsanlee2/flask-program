...
from src.cmm.const.path import MPG_DATA_CTX, MPG_SAVE_CTX
...
class Mpg:
    mpg = pd.read_csv(MPG_DATA_CTX+'mpg.csv')
    def __init__(self):
        self.mpg = pd.read_csv(MPG_DATA_CTX+'mpg.csv')
    def menu_1(self):
        print(self.mpg.head())
    ...
    def menu_10(self):
        ...
        plt.savefig(MPG_SAVE_CTX+'mpg_graph.jpg')
