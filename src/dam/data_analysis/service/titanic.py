...
from src.cmm.const.path import TITANIC_DATA_CTX
from src.cmm.service.common import Common
from src.cmm.service.dataset import Dataset
from src.utl.fcc.lambdas import Learning
...
class TitanicController(object):
    ...
    def learning(self, train, test, cmd):  # 기계학습
        algo = Learning(cmd)
        this = self.modeling(train, test)
        accuracy = self.model.get_accuracy(this, algo)
        print(f"{cmd} 정확도: {accuracy} %")
